...
func (_c *ProjectCreate) SetRemark(v string) *ProjectCreate {
	_c.mutation.SetRemark(v)
	return _c
}

// SetNillableRemark sets the "remark" field if the given value is not nil.
func (_c *ProjectCreate) SetNillableRemark(v *string) *ProjectCreate {
	if v != nil {
		_c.SetRemark(*v)
	}
	return _c
...
func (_c *ProjectCreate) AddDemandIDs(ids ...int) *ProjectCreate {
	_c.mutation.AddDemandIDs(ids...)
	return _c
}

// AddDemands adds the "demands" edges to the Demand entity.
func (_c *ProjectCreate) AddDemands(v ...*Demand) *ProjectCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddDemandIDs(ids...)
}
...
func (_c *ProjectCreate) createSpec() (*Project, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DemandsIDs(); len(nodes) > 0 {
