...
func (e TagEdges) DemandsOrErr() ([]*Demand, error) {
	if e.loadedTypes[0] {
...
// QueryDemands queries the "demands" edge of the Tag entity.
func (_m *Tag) QueryDemands() *DemandQuery {
	return NewTagClient(_m.config).QueryDemands(_m)
}
