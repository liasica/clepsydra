...
type ProjectEdges struct {
	// Demands holds the value of the demands edge.
...
// DemandsOrErr returns the Demands value or an error if the edge
// was not loaded in eager-loading.
func (e ProjectEdges) DemandsOrErr() ([]*Demand, error) {
	if e.loadedTypes[0] {
		return e.Demands, nil
	}
	return nil, &NotLoadedError{edge: "demands"}
}
...
func (*Project) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case project.FieldName, project.FieldColor, project.FieldRemark:
...
// QueryDemands queries the "demands" edge of the Project entity.
func (_m *Project) QueryDemands() *DemandQuery {
	return NewProjectClient(_m.config).QueryDemands(_m)
}
