...
type Demand struct {
	...
	// The values are being populated by the DemandQuery when eager-loading is set.
	Edges        DemandEdges `json:"edges"`
	selectValues sql.SelectValues
}

// DemandEdges holds the relations/edges for other nodes in the graph.
...
func (e DemandEdges) ProjectsOrErr() ([]*Project, error) {
	if e.loadedTypes[0] {
